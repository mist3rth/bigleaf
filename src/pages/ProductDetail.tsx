  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 md:px-8 py-8 animate-fade-in text-primary" id="product-detail-page">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-[11px] font-mono uppercase tracking-widest text-primary/40 hidden sm:block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-secondary/40 rounded-2xl p-3.5 text-center border border-primary/5">
              ...
              <p className="text-[9px] text-primary/50 mt-0.5">Remplacement gratuit</p>
            </div>
            <div className="bg-secondary/40 rounded-2xl p-3.5 text-center border border-primary/5">
              ...
              <p className="text-[9px] text-primary/50 mt-0.5">Rempoté par nos soins</p>
            </div>
            <div className="bg-secondary/40 rounded-2xl p-3.5 text-center border border-primary/5">
              ...
              <p className="text-[9px] text-primary/50 mt-0.5">Envoi sécurisé hiver</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 text-left space-y-6">
              ...
              <div className="flex items-center gap-2">
                <div className="flex text-gold">
                  {[...Array(5)].map((_, i) => (
                    <Star 
                      key={i} 
                      className={`w-4 h-4 ${i < Math.floor(plant.rating) ? 'fill-current text-gold' : 'text-primary/20'}`} 
                    />
                  ))}
                </div>
                <span className="text-xs font-bold">{plant.rating} / 5</span>
                <span className="text-xs text-primary/40">({plant.reviewsCount} avis vérifiés)</span>
              </div>
              <div className="text-right">
                <span className="text-[10px] uppercase tracking-wider text-primary/40 block">Prix à l'unité</span>
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-mono uppercase tracking-widest text-primary/40">Description horticole</h3>
          ...
          <div className="grid grid-cols-3 gap-4 bg-secondary/30 rounded-2xl p-4.5 border border-primary/5">
            <div>
              <span className="text-[10px] uppercase tracking-wider text-primary/40 block font-mono">Taille</span>
              <span className="text-xs font-bold text-primary">{plant.size}</span>
            </div>
            <div>
              <span className="text-[10px] uppercase tracking-wider text-primary/40 block font-mono">Origine</span>
              <span className="text-xs font-bold text-primary">{plant.origin}</span>
            </div>
            <div>
              <span className="text-[10px] uppercase tracking-wider text-primary/40 block font-mono flex items-center gap-1">
                <PawPrint className="w-3 h-3 text-primary/40 inline" /> Animaux
              </span>
          ...
          <div className="pt-2">
            ...
            <p className="text-[10px] text-center text-primary/40 mt-3 font-sans">
              ...
              {activeTab === 'care' && (
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="text-xs font-extrabold uppercase tracking-widest text-primary">Lumière & Exposition</h4>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="text-xs font-extrabold uppercase tracking-widest text-primary">Fréquence d'Arrosage</h4>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="text-xs font-extrabold uppercase tracking-widest text-primary">Climat & Températures</h4>
              ...
              {activeTab === 'details' && (
                <div className="space-y-3 font-sans text-xs">
                  <div className="flex justify-between py-1 border-b border-primary/5">
                    <span className="text-primary/50 uppercase font-mono tracking-wider">Classification</span>
                    <span className="font-bold text-primary">Plante succulente</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-primary/5">
                    <span className="text-primary/50 uppercase font-mono tracking-wider">Nom botanique</span>
                    <span className="font-bold text-primary italic">{plant.scientificName}</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-primary/5">
                    <span className="text-primary/50 uppercase font-mono tracking-wider">Substrat conseillé</span>
                    <span className="font-bold text-primary">30% terreau premium, 40% pouzzolane, 30% sable</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-primary/5">
                    <span className="text-primary/50 uppercase font-mono tracking-wider">Toxicité animaux</span>
                  ...
                  <div className="flex justify-between py-1">
                    <span className="text-primary/50 uppercase font-mono tracking-wider">Période de croissance</span>
          ...
          {companionPlants.map((companion) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-between flex-grow">
                <div>
                  <span className="text-[9px] uppercase tracking-wider font-mono text-primary/40">
                    {companion.scientificName}
                  </span>
                  <h4 className="font-display font-bold text-base text-primary leading-tight mt-0.5 group-hover:text-accent transition-colors">
                    {companion.name}
                  </h4>
